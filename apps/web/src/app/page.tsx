		...
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
			...
			<section className="container mx-auto px-4 py-20 text-center">
				<div className="max-w-4xl mx-auto">
					...
					<p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
						SYA est votre Jarvis open-source. Un assistant IA qui fonctionne
						100% en local, respecte votre vie privée et vous aide dans vos
						tâches quotidiennes.
					</p>
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
					<div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
						...
						<p className="text-gray-300">
							Fonctionne entièrement sur votre machine. Aucune donnée ne quitte
							votre ordinateur.
						</p>
					</div>
					...
					<div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
						...
						<p className="text-gray-300">
							Optimisé en Rust pour des performances maximales. Réponse
							instantanée.
						</p>
					</div>
					...
					<div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
						...
						<p className="text-gray-300">
							Utilise les derniers modèles d'IA locale via Ollama. Conversation
							naturelle.
						</p>
					</div>
					...
					<div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
						...
						<p className="text-gray-300">
							Fonctionne hors ligne. Aucune connexion internet requise après
							l'installation.
						</p>
					</div>
					...
					<div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
						...
						<p className="text-gray-300">
							Support multi-utilisateurs avec base de données PostgreSQL. Chacun
							son espace.
						</p>
					</div>
					...
					<div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
						...
						<p className="text-gray-300">
							Code source ouvert et transparent. Contribuez et personnalisez
							selon vos besoins.
						</p>
					</div>
				</div>
			...
			<section
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-300 max-w-2xl mx-auto">
						Choisissez votre plateforme et commencez à utiliser votre assistant
						IA personnel
					</p>
				</div>
			...
			<footer className="container mx-auto px-4 py-12 border-t border-white/20">
				<div className="text-center">
					...
					<div className="flex justify-center space-x-6 mb-6">
						<a
							href="https://github.com/Sycatle/SYA"
						...
						<div className="grid md:grid-cols-3 gap-6 text-sm">
							<div className="text-gray-400">
								...
								<p>
									Développé par{" "}
									<a
										href="https://github.com/Sycatle"
										className="text-blue-400 hover:text-blue-300">
										@sycatle
									</a>{" "}
									et{" "}
									<a
										href="https://github.com/risk-alt"
										className="text-blue-400 hover:text-blue-300">
										@risk
									</a>
								</p>
							...
							<div className="text-gray-400">
								...
								<a
									href="https://github.com/Sycatle/SYA/graphs/contributors"
									className="text-blue-400 hover:text-blue-300">
									Voir la liste
								</a>
							</div>
